...
class VtigerConnector {
    ...
    sendRequest(currentModel, operationMethod, data, next) {
        data = JSON.stringify(data);
        this.getFreeSession((err, session) => {
            this.request(session, currentModel, VtigerConnector.getOperation(this, currentModel) + "." + operationMethod, data, next);
        });
    }
    ...
    create(currentModel, data, params, next) {
        data = JSON.stringify(data);
        this.getFreeSession((err, session) => {
            this.request(session, currentModel, VtigerConnector.getOperation(this, currentModel) + '.create', data, next);
        });
